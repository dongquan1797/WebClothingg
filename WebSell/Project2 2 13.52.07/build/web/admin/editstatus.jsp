<%-- 
    Document   : editstatus
    Created on : Dec 17, 2021, 1:08:23 PM
    Author     : Quan
--%>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-tablet-alt"></i> Status Information
                        </div>
                        <div class="card-body">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td> Status ID </td>
                                        <td>
                                            <input type="text" name="staID" class="form-control" value="${status.statusId}" readonly="true" placeholder="Status ID Auto"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> Status Name </td>
                                        <td>
                                            <input type="text" name="staName" class="form-control" value="${status.statusName}" placeholder="Status Name"/>
                                        </td>
                                    </tr>
                                    <tr>                                        
