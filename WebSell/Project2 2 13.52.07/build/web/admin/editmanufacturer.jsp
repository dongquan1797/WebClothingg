                                    ...
                                    <table style="text-align: center">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="maId" value="${manufacturer.manufacturerId}" placeholder="Manufacturer ID Auto" readonly="true" class="form-control"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td> Manufacturer Name </td>
                                                <td>
                                                    <input type="text" class="form-control" value="${manufacturer.manufacturerName}" name="maName" placeholder="Manufacturer Name" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td> Nation </td>
                                                <td>
                                                    <select name="naID" class="form-select">
                                                        <c:forEach var="n" items="${lstNation}">
                                                            <option value="${n.nationId}" ${manufacturer.nationId==n.nationId?"selected='selected'":""}>
                                                                ${n.nationName}
                                                            </option>
                                                        </c:forEach>
                                                    </select>                                                    
