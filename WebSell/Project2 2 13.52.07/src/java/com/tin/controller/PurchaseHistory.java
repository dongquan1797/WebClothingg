...
public class PurchaseHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int cusID = cusDAO.getByUserName(user).getCustomerId();
        ArrayList<Bill> lst=billDAO.getByCustomerId(cusID);
        request.setAttribute("listBill", lst);
        RequestDispatcher d = request.getRequestDispatcher("history.jsp");
