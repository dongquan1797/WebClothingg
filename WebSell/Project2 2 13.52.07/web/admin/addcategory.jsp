<%-- 
    ...
    Created on : Dec 14, 2021, 12:33:02 PM
    Author     : Quan
--%>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item action">Add New Category</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-tablet-alt me-1"></i> Category Information
                        </div>
                        <div class="card-body">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td> Category ID</td>
                                        <td>
                                            <input type="text" name="categoryid" placeholder="Category ID Auto" readonly="true" class="form-control"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> Category Name</td>
